...
const int PB11 = 23, PB12 = 19, PB21 = 25, PB22 = 27;
/*
...
void processGamepad(ControllerPtr ctl) {
  ...
  if (ctl->buttons() == 0x0004) {
    if(digitalRead(PB21)){
      ...
      Serial.println("Gaveta 2  já fechada!");
    }
  ...
  if(ctl->buttons() != 0x0004 || digitalRead(PB21))
    analogWrite(D2_Backward, 0);
  ...
  if (ctl->buttons() == 0x0008) {
    if(digitalRead(PB12)){
      ...
      Serial.println("Gaveta 1 já aberta!");
    }
  ...
  if(ctl->buttons() != 0x0008 || digitalRead(PB12))
    analogWrite(D1_Forward, 0);
  ...
  if (ctl->buttons() == 0x0002) {
    if(digitalRead(PB22)){
      ...
      Serial.println("Gaveta 2 já aberta!");
    }
  ...
  if(ctl->buttons() != 0x0002 || digitalRead(PB22))
    analogWrite(D2_Forward, 0);
